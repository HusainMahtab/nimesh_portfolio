...
function ContactMe() {
  ...
  return (
    <div className='w-full flex justify-center items-center p-14 md:p-8'>
        <div className='bg-white h-[400px] w-[350px] grid rounded shadow-lg'>
            ...
            <form action="submit" className='w-[300px] grid gap-4 justify-center place-content-center p-4' onSubmit={handleSubmit}>
                ...
                <div className='w-full h-12 flex justify-center items-center'>
                  <button className='text-lg font-bold bg-[#FF0000] p-2 px-4 w-32 text-white rounded'>Submit</button>
                  <Toaster/>
                </div>
            </form>
